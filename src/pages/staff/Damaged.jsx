...
const Damaged = () => {
    ...
    const handleBorrow = async () => {  
        ...
        const payload = {
            ...
            damagedTime: data.date,
            thoughts: data.thoughts,
            userId,
        };

        const results = await axios.post(`${URL}/api/depreciated`, payload);
  ...
  return (
    <div className='w-full flex flex-col'>
        <h1 className='text-3xl font-bold text-center mt-20'>Report Deprecieted</h1>
